    ...
    public class Сенсоры : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СенсорыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СенсорыE", typeof(IIS.Fyvvyf.Сенсоры));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СенсорыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СенсорыL", typeof(IIS.Fyvvyf.Сенсоры));
                }
            }
        }
    }
