...
namespace IIS.Fyvvyf
{
    ...
    public class ОтчетОСервере : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fyvvyf.РежимСервера fРежим;
        
        private IIS.Fyvvyf.Расположение fРасположение;
        ...
        public virtual IIS.Fyvvyf.РежимСервера Режим
        {
            get
            {
                ...
                IIS.Fyvvyf.РежимСервера result = this.fРежим;
        ...
        [PropertyStorage(new string[] {
                "Расположение"})]
        [NotNull()]
        public virtual IIS.Fyvvyf.Расположение Расположение
        {
            get
            {
                ...
                IIS.Fyvvyf.Расположение result = this.fРасположение;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереE", typeof(IIS.Fyvvyf.ОтчетОСервере));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтчетОСервереL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтчетОСервереL", typeof(IIS.Fyvvyf.ОтчетОСервере));
                }
            }
        }
    }
