...
namespace IIS.Fyvvyf
{
    ...
    public class Серверная : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Fyvvyf.Сотрудник fСотрудник;
        
        private IIS.Fyvvyf.DetailArrayOfКонтроллер fКонтроллер;
        ...
        [PropertyStorage(new string[] {
                "Сотрудник"})]
        [NotNull()]
        public virtual IIS.Fyvvyf.Сотрудник Сотрудник
        {
            get
            {
                ...
                IIS.Fyvvyf.Сотрудник result = this.fСотрудник;
        ...
        public virtual IIS.Fyvvyf.DetailArrayOfКонтроллер Контроллер
        {
            get
            {
                ...
                {
                    this.fКонтроллер = new IIS.Fyvvyf.DetailArrayOfКонтроллер(this);
                }
                IIS.Fyvvyf.DetailArrayOfКонтроллер result = this.fКонтроллер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СервернаяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяE", typeof(IIS.Fyvvyf.Серверная));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СервернаяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяL", typeof(IIS.Fyvvyf.Серверная));
                }
            }
        }
    }
